...
disk::disk(int _plato, int _pistasPorPlato, int _sectorPorPistas, int _sizeSector, int _sizebloque)
{
    ...
    sectoresPorBloque = sizeBloque / sizeSector;
    bloquesPorPista = static_cast<int>(ceil(static_cast<float>(sectorPorPistas) / sectoresPorBloque));
    bloquesTotales = bloquesPorPista * pistasPorPlato * superficie;
    sectoresPorBloque = sizeBloque / sizeSector;
}
...
{   
    ...
    cout << "---------------------------------------------------------------------" << endl;
    cout << "Cantidad de platos: " << getPlato() << endl;
    cout << "Cantidad de pistas por plato: " << getPistasPorPlato() << endl;
    cout << "Cantidad de superficie: " << getSuperficie() << endl;
    cout << "Cantidad de sectores por pista: " << getSectorPorPistas() << endl;
    cout << "Tamaño de sector: " << getSizeSector() << endl;
    cout << "Tamaño de bloque: " << getSizeBloque() << endl;
    cout << "Capacidad del disco: " << getCapacidad() << endl;
    cout << "Sectores totales: " << getSectores() << endl;
    cout << "Pistas totales: " << getPistas() << endl;
    cout << "Sectores por bloque: " << getSectoresPorBloque() << endl;
    cout << "Bloques por pista: " << getBloquesPorPista()<< endl;
    cout<< "Bloques por plato: " << getBloquesPorPista() * getPistasPorPlato() << endl;
    cout << "Bloques totales: " << getBloquesTotales() << endl;
    cout << "---------------------------------------------------------------------" << endl;
}